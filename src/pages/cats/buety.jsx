...
import style from '../cats/cates.module.css'
import { useNavigate } from 'react-router-dom';

function buety({ fillpros }) {
                    ...
                    <div className={style.products} >
                        {
                            fillpros.map(pros =>
                                <>
                                    <div className={`card ${style.productCard}`} style={{ display: pros.pstatus === -1 ? "none" : "block" }} onClick={() => prodetails(pros)}>
